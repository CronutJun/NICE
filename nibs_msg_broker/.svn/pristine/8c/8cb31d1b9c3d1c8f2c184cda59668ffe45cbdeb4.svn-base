...
import com.nicetcm.nibsplus.broker.msg.model.TFnNiceCloseKey;
...
public interface TFnNiceCloseMapper {
    /**
     ...
     */
    @SelectProvider(type=TFnNiceCloseSqlProvider.class, method="countBySpec")
    int countBySpec(TFnNiceCloseSpec spec);
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    @DeleteProvider(type=TFnNiceCloseSqlProvider.class, method="deleteBySpec")
    int deleteBySpec(TFnNiceCloseSpec spec);
     ...
     */
    @Insert({
        "insert into OP.T_FN_NICE_CLOSE (MAC_NO, CLOSE_DATE, ",
        "DEPT_CD, OFFICE_CD, ",
        "TEAM_CD, CLOSE_TIME, ",
        "TRACK1_EMIT_CNT, TRACK1_BACK_CNT, ",
        "TRACK2_EMIT_CNT, TRACK2_BACK_CNT, ",
        "TRACK3_EMIT_CNT, TRACK3_BACK_CNT, ",
        "TRACK4_EMIT_CNT, TRACK4_BACK_CNT, ",
        "TOT_EMIT_CNT, TOT_EMIT_AMT, ",
        "DEPOSIT_CNT, DEPOSIT_AMT, ",
        "SERVICE_CNT, SERVICE_AMT, ",
        "ABROAD_CNT, ABROAD_AMT, ",
        "ETC_CNT, ETC_AMT, ",
        "CASH_NOT_TAKEN_CNT, CASH_NOT_TAKEN_AMT, ",
        "UNDETERMINED_BILLS_CNT, UNDETERMINED_BILLS_AMT, ",
        "SEND_FAILS_CNT, SENT_FAILS_AMT, ",
        "TIME_OUT_CNT, TIME_OUT_AMT, ",
        "INSERT_DATE, INSERT_UID, ",
        "TOT_IN_CNT, TOT_IN_AMT, ",
        "CHECK_IN_CNT, CHECK_IN_AMT, ",
        "CHECK_OUT_CNT, CHECK_OUT_AMT, ",
        "EMIT_CNT_CW14, EMIT_CNT_CW54, ",
        "EMIT_CNT_CW15, IN_CNT_CW14, ",
        "IN_CNT_CW54, IN_CNT_CW15, ",
        "IN_AMT_ETC, TRACK_USE_TYPE)",
        "values (#{macNo,jdbcType=VARCHAR}, #{closeDate,jdbcType=VARCHAR}, ",
        "#{deptCd,jdbcType=VARCHAR}, #{officeCd,jdbcType=VARCHAR}, ",
        "#{teamCd,jdbcType=VARCHAR}, #{closeTime,jdbcType=VARCHAR}, ",
        "#{track1EmitCnt,jdbcType=DECIMAL}, #{track1BackCnt,jdbcType=DECIMAL}, ",
        "#{track2EmitCnt,jdbcType=DECIMAL}, #{track2BackCnt,jdbcType=DECIMAL}, ",
        "#{track3EmitCnt,jdbcType=DECIMAL}, #{track3BackCnt,jdbcType=DECIMAL}, ",
        "#{track4EmitCnt,jdbcType=DECIMAL}, #{track4BackCnt,jdbcType=DECIMAL}, ",
        "#{totEmitCnt,jdbcType=DECIMAL}, #{totEmitAmt,jdbcType=DECIMAL}, ",
        "#{depositCnt,jdbcType=DECIMAL}, #{depositAmt,jdbcType=DECIMAL}, ",
        "#{serviceCnt,jdbcType=DECIMAL}, #{serviceAmt,jdbcType=DECIMAL}, ",
        "#{abroadCnt,jdbcType=DECIMAL}, #{abroadAmt,jdbcType=DECIMAL}, ",
        "#{etcCnt,jdbcType=DECIMAL}, #{etcAmt,jdbcType=DECIMAL}, ",
        "#{cashNotTakenCnt,jdbcType=DECIMAL}, #{cashNotTakenAmt,jdbcType=DECIMAL}, ",
        "#{undeterminedBillsCnt,jdbcType=DECIMAL}, #{undeterminedBillsAmt,jdbcType=DECIMAL}, ",
        "#{sendFailsCnt,jdbcType=DECIMAL}, #{sentFailsAmt,jdbcType=DECIMAL}, ",
        "#{timeOutCnt,jdbcType=DECIMAL}, #{timeOutAmt,jdbcType=DECIMAL}, ",
        "#{insertDate,jdbcType=TIMESTAMP}, #{insertUid,jdbcType=VARCHAR}, ",
        "#{totInCnt,jdbcType=DECIMAL}, #{totInAmt,jdbcType=DECIMAL}, ",
        "#{checkInCnt,jdbcType=DECIMAL}, #{checkInAmt,jdbcType=DECIMAL}, ",
        "#{checkOutCnt,jdbcType=DECIMAL}, #{checkOutAmt,jdbcType=DECIMAL}, ",
        "#{emitCntCw14,jdbcType=DECIMAL}, #{emitCntCw54,jdbcType=DECIMAL}, ",
        "#{emitCntCw15,jdbcType=DECIMAL}, #{inCntCw14,jdbcType=DECIMAL}, ",
        "#{inCntCw54,jdbcType=DECIMAL}, #{inCntCw15,jdbcType=DECIMAL}, ",
        "#{inAmtEtc,jdbcType=DECIMAL}, #{trackUseType,jdbcType=CHAR})"
    })
    int insert(TFnNiceClose record);
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    @InsertProvider(type=TFnNiceCloseSqlProvider.class, method="insertSelective")
    int insertSelective(TFnNiceClose record);
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    @SelectProvider(type=TFnNiceCloseSqlProvider.class, method="selectBySpec")
    @Results({
    ...
    List<TFnNiceClose> selectBySpec(TFnNiceCloseSpec spec);
    ...
    @Select({
        "select",
        "MAC_NO, CLOSE_DATE, DEPT_CD, OFFICE_CD, TEAM_CD, CLOSE_TIME, TRACK1_EMIT_CNT, ",
        "TRACK1_BACK_CNT, TRACK2_EMIT_CNT, TRACK2_BACK_CNT, TRACK3_EMIT_CNT, TRACK3_BACK_CNT, ",
        "TRACK4_EMIT_CNT, TRACK4_BACK_CNT, TOT_EMIT_CNT, TOT_EMIT_AMT, DEPOSIT_CNT, DEPOSIT_AMT, ",
        "SERVICE_CNT, SERVICE_AMT, ABROAD_CNT, ABROAD_AMT, ETC_CNT, ETC_AMT, CASH_NOT_TAKEN_CNT, ",
        "CASH_NOT_TAKEN_AMT, UNDETERMINED_BILLS_CNT, UNDETERMINED_BILLS_AMT, SEND_FAILS_CNT, ",
        "SENT_FAILS_AMT, TIME_OUT_CNT, TIME_OUT_AMT, INSERT_DATE, INSERT_UID, TOT_IN_CNT, ",
        "TOT_IN_AMT, CHECK_IN_CNT, CHECK_IN_AMT, CHECK_OUT_CNT, CHECK_OUT_AMT, EMIT_CNT_CW14, ",
        "EMIT_CNT_CW54, EMIT_CNT_CW15, IN_CNT_CW14, IN_CNT_CW54, IN_CNT_CW15, IN_AMT_ETC, ",
        "TRACK_USE_TYPE",
    ...
    TFnNiceClose selectByPrimaryKey(TFnNiceCloseKey key);
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    @UpdateProvider(type=TFnNiceCloseSqlProvider.class, method="updateBySpecSelective")
    int updateBySpecSelective(@Param("record") TFnNiceClose record, @Param("spec") TFnNiceCloseSpec spec);
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    @UpdateProvider(type=TFnNiceCloseSqlProvider.class, method="updateBySpec")
    int updateBySpec(@Param("record") TFnNiceClose record, @Param("spec") TFnNiceCloseSpec spec);
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    @UpdateProvider(type=TFnNiceCloseSqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(TFnNiceClose record);
    ...
    @Update({
        ...
        "set DEPT_CD = #{deptCd,jdbcType=VARCHAR},",
          ...
          "TRACK1_EMIT_CNT = #{track1EmitCnt,jdbcType=DECIMAL},",
    ...
    int updateByPrimaryKey(TFnNiceClose record);
}