    ...
    public void inMsgBizProc(MsgBrokerData safeData, MsgParser parsed) throws Exception {
        ...
        if(isDbDupData) {
            ...
            try
            {
                ...
                tFnInoutStat.setSiteCd    (macInfo.getSiteCd());
                tFnInoutStat.setTradeDate (MsgBrokerLib.rtrim(parsed.getString("trade_date")));
                tFnInoutStat.setIn01      (parsed.getLong("in01" ));
                tFnInoutStat.setOut01     (parsed.getLong("out01"));
                tFnInoutStat.setIn02      (parsed.getLong("in02" ));
                tFnInoutStat.setOut02     (parsed.getLong("out02"));
                tFnInoutStat.setIn03      (parsed.getLong("in03" ));
                tFnInoutStat.setOut03     (parsed.getLong("out03"));
                tFnInoutStat.setIn04      (parsed.getLong("in04" ));
                tFnInoutStat.setOut04     (parsed.getLong("out04"));
                tFnInoutStat.setIn05      (parsed.getLong("in05" ));
                tFnInoutStat.setOut05     (parsed.getLong("out05"));
                tFnInoutStat.setIn06      (parsed.getLong("in06" ));
                tFnInoutStat.setOut06     (parsed.getLong("out06"));
                tFnInoutStat.setIn07      (parsed.getLong("in07" ));
                tFnInoutStat.setOut07     (parsed.getLong("out07"));
                tFnInoutStat.setIn08      (parsed.getLong("in08" ));
                tFnInoutStat.setOut08     (parsed.getLong("out08"));
                tFnInoutStat.setIn09      (parsed.getLong("in09" ));
                tFnInoutStat.setOut09     (parsed.getLong("out09"));
                tFnInoutStat.setIn10      (parsed.getLong("in10" ));
                tFnInoutStat.setOut10     (parsed.getLong("out10"));
                tFnInoutStat.setIn11      (parsed.getLong("in11" ));
                tFnInoutStat.setOut11     (parsed.getLong("out11"));
                tFnInoutStat.setIn12      (parsed.getLong("in12" ));
                tFnInoutStat.setOut12     (parsed.getLong("out12"));
                tFnInoutStat.setIn13      (parsed.getLong("in13" ));
                tFnInoutStat.setOut13     (parsed.getLong("out13"));
                tFnInoutStat.setIn14      (parsed.getLong("in14" ));
                tFnInoutStat.setOut14     (parsed.getLong("out14"));
                tFnInoutStat.setIn15      (parsed.getLong("in15" ));
                tFnInoutStat.setOut15     (parsed.getLong("out15"));
                tFnInoutStat.setIn16      (parsed.getLong("in16" ));
                tFnInoutStat.setOut16     (parsed.getLong("out16"));
                tFnInoutStat.setIn17      (parsed.getLong("in17" ));
                tFnInoutStat.setOut17     (parsed.getLong("out17"));
                tFnInoutStat.setIn18      (parsed.getLong("in18" ));
                tFnInoutStat.setOut18     (parsed.getLong("out18"));
                tFnInoutStat.setIn19      (parsed.getLong("in19" ));
                tFnInoutStat.setOut19     (parsed.getLong("out19"));
                tFnInoutStat.setIn20      (parsed.getLong("in20" ));
                tFnInoutStat.setOut20     (parsed.getLong("out20"));
                tFnInoutStat.setIn21      (parsed.getLong("in21" ));
                tFnInoutStat.setOut21     (parsed.getLong("out21"));
                tFnInoutStat.setIn22      (parsed.getLong("in22" ));
                tFnInoutStat.setOut22     (parsed.getLong("out22"));
                tFnInoutStat.setIn23      (parsed.getLong("in23" ));
                tFnInoutStat.setOut23     (parsed.getLong("out23"));
                tFnInoutStat.setIn24      (parsed.getLong("in24" ));
                tFnInoutStat.setOut24     (parsed.getLong("out24"));
                tFnInoutStat.setUpdateDate(safeData.getDSysDate());
