...
public interface TCtErrorCallMapper {
    ...
    @Insert({
        ...
        "#{arrivalPdaTime,jdbcType=VARCHAR}, #{arrivalXpos,jdbcType=DECIMAL}, ",
        "#{arrivalYpos,jdbcType=DECIMAL}, #{arrivalSido,jdbcType=VARCHAR}, ",
    ...
    @Update({
        ...
        "set ARRIVAL_DATE = #{arrivalDate,jdbcType=VARCHAR},",
          ...
          "ARRIVAL_XPOS = #{arrivalXpos,jdbcType=DECIMAL},",
          "ARRIVAL_YPOS = #{arrivalYpos,jdbcType=DECIMAL},",
