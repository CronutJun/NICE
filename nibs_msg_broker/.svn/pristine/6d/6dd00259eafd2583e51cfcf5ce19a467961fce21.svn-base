 ...
 * @see
 */
public class NhFtpTasklet implements Tasklet {

    private static final Logger logger = LoggerFactory.getLogger(NhFtpTasklet.class);
    ...
    @Value("#{config['nh.remote.path']}")
    private String remotePath;

    @Value("#{config['nh.local.path']}")
