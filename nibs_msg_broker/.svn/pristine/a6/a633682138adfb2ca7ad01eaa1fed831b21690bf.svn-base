...
public class In01101150Impl extends InMsgHandlerImpl {
    ...
    public void inMsgBizProc(MsgBrokerData safeData, MsgParser parsed) throws Exception {
        ...
        if(MsgBrokerConst.SHATMS_CODE.equals(parsed.getString("CM.org_cd"))) {
           ...
           **********************************************************************************************/
            if(parsed.getString("call_class").equals("2")) {
                ...
                {
                    logger.info( ">>> [MngEM_SaveErrCall] (T_CT_ERROR_MNG_MADE_COM) UPDATE ERROR [%.200s]", e.getMessage());
                }
                ...
                logger.info("!!! 신한은행 2차출동 도착예정보고  처리완료(T_CT_ERROR_MNG_MADE_COM UPDATE)!!!");
            ...
            ************************************************************************************************/
            ...
            if(parsed.getString("CM.ret_cd_src").equals("B")) {
                ...
                logger.info("[SaveArrivalSchdule] 응답코드[{}]수신", parsed.getString("CM.ret_cd_src") + parsed.getString("CM.ret_cd"));
                return;
            }
            ...
            ************************************************************************************************/
            ...
            if(MsgBrokerConst.KBST_CODE.equals(parsed.getString("CM.org_cd"))) {
                ...
                ************************************************************************************************/
                ...
                logger.info("[SaveArrivalSchdule] 도착예정통보가 지원되지 않는 기관입니다.[%s]", parsed.getString("CM.org_cd"));
        ...
        logger.info( "[SaveArrivalSchdule] Update OK" );
