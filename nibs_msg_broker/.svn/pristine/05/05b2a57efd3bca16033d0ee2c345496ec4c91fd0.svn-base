...
import com.nicetcm.nibsplus.broker.msg.model.TFnElandCouponSpec.Criteria;
import com.nicetcm.nibsplus.broker.msg.model.TFnElandCouponSpec.Criterion;
import com.nicetcm.nibsplus.broker.msg.model.TFnElandCouponSpec;
import java.util.List;
import java.util.Map;

public class TFnElandCouponSqlProvider {
     ...
     */
    public String countBySpec(TFnElandCouponSpec spec) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Thu Jul 31 14:31:01 KST 2014
     */
    public String deleteBySpec(TFnElandCouponSpec spec) {
        BEGIN();
        DELETE_FROM("OP.T_FN_ELAND_COUPON");
        applyWhere(spec, false);
        return SQL();
    }
     ...
     * @mbggenerated Thu Jul 31 14:31:01 KST 2014
     */
    public String insertSelective(TFnElandCoupon record) {
        BEGIN();
        INSERT_INTO("OP.T_FN_ELAND_COUPON");
        ...
        if (record.getCouponCd() != null) {
            VALUES("COUPON_CD", "#{couponCd,jdbcType=VARCHAR}");
        }
        
        if (record.getVolumeCd() != null) {
            VALUES("VOLUME_CD", "#{volumeCd,jdbcType=VARCHAR}");
        }
        ...
        if (record.getConfirm() != null) {
            VALUES("CONFIRM", "#{confirm,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Thu Jul 31 14:31:01 KST 2014
     */
    public String selectBySpec(TFnElandCouponSpec spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TFnElandCoupon record = (TFnElandCoupon) parameter.get("record");
        TFnElandCouponSpec spec = (TFnElandCouponSpec) parameter.get("spec");
        ...
        if (record.getCouponCd() != null) {
            SET("COUPON_CD = #{record.couponCd,jdbcType=VARCHAR}");
        }
        
        if (record.getVolumeCd() != null) {
            SET("VOLUME_CD = #{record.volumeCd,jdbcType=VARCHAR}");
        }
        ...
        if (record.getConfirm() != null) {
            SET("CONFIRM = #{record.confirm,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Thu Jul 31 14:31:01 KST 2014
     */
    public String updateByPrimaryKeySelective(TFnElandCoupon record) {
        BEGIN();
        UPDATE("OP.T_FN_ELAND_COUPON");
        ...
        if (record.getConfirm() != null) {
            SET("CONFIRM = #{confirm,jdbcType=VARCHAR}");
        }
        ...
        WHERE("COUPON_CD = #{couponCd,jdbcType=VARCHAR}");
        WHERE("VOLUME_CD = #{volumeCd,jdbcType=VARCHAR}");
     ...
     * @mbggenerated Thu Jul 31 14:31:01 KST 2014
     */
    protected void applyWhere(TFnElandCouponSpec spec, boolean includeSpecPhrase) {
        if (spec == null) {
            return;
        }
