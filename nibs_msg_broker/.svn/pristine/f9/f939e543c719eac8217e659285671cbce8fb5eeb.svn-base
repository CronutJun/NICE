...
import com.nicetcm.nibsplus.broker.msg.model.TCtOpenSpec.Criteria;
import com.nicetcm.nibsplus.broker.msg.model.TCtOpenSpec.Criterion;
import com.nicetcm.nibsplus.broker.msg.model.TCtOpenSpec;
import java.util.List;
import java.util.Map;

public class TCtOpenSqlProvider {
     ...
     */
    public String countBySpec(TCtOpenSpec spec) {
        BEGIN();
        SELECT("count(*)");
        FROM("OP.T_CT_OPEN");
     ...
     * @mbggenerated Wed Jul 23 14:42:30 KST 2014
     */
    public String deleteBySpec(TCtOpenSpec spec) {
        BEGIN();
        DELETE_FROM("OP.T_CT_OPEN");
        applyWhere(spec, false);
        return SQL();
    }
     ...
     * @mbggenerated Wed Jul 23 14:42:30 KST 2014
     */
    public String insertSelective(TCtOpen record) {
        BEGIN();
        INSERT_INTO("OP.T_CT_OPEN");
     ...
     * @mbggenerated Wed Jul 23 14:42:30 KST 2014
     */
    public String selectBySpec(TCtOpenSpec spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TCtOpen record = (TCtOpen) parameter.get("record");
        TCtOpenSpec spec = (TCtOpenSpec) parameter.get("spec");
        ...
        if (record.getOpenTime() != null) {
            SET("OPEN_TIME = #{record.openTime,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Wed Jul 23 14:42:30 KST 2014
     */
    public String updateByPrimaryKeySelective(TCtOpen record) {
        BEGIN();
        UPDATE("OP.T_CT_OPEN");
     ...
     * @mbggenerated Wed Jul 23 14:42:30 KST 2014
     */
    protected void applyWhere(TCtOpenSpec spec, boolean includeSpecPhrase) {
        if (spec == null) {
            return;
        }
