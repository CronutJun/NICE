...
public class In03101210ImplTest extends CmAllTestSuite
{
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    @Resource(name="in03101210")
    InMsgHandler inMsgHandler;

    @Test
    public void testCase1() throws Exception {
        final String testMsg = "004B00  HOST   0422201407160709423697636         CM03101210                               K2497   K9T         11111                                                                                                                                                                                                                                                                                                                                                                                                             ";
