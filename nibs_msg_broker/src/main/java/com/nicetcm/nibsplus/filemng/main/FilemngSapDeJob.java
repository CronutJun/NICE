...
public class FilemngSapDeJob {
	
	public FilemngSapDeJob(String[] args) {
		String[] springConfig = {
			"classpath:/filemng/spring/context-filemng.xml",
			"classpath:/filemng/spring/context-filemng-sapDeJob.xml" };
		...
		try {
			...
			JobExecution execution = jobLauncher.run((Job)context.getBean("sapDeJob"), jobParameters);
