 ...
 * @see
 */
public class VpnFtpTasklet implements Tasklet {

    private static final Logger logger = LoggerFactory.getLogger(VpnFtpTasklet.class);
    ...
    @Value("#{config['vpnip.remote.path']}")
    private String remotePath;

    @Value("#{config['vpnip.local.path']}")
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception
    {
        ...
        try {
	        jobParameters.getParameters().put("vpn.file.name", new JobParameter(getFile(transferVO).getAbsolutePath()));
        } catch(Exception e) {
