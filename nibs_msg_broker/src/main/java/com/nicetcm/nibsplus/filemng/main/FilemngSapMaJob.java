...
public class FilemngSapMaJob {
	
	public FilemngSapMaJob(String[] args) {
		String[] springConfig = {
			"classpath:/filemng/spring/context-filemng.xml",
			"classpath:/filemng/spring/context-filemng-sapMaJob.xml" };
		...
		try {
			...
			JobExecution execution = jobLauncher.run((Job)context.getBean("sapMaJob"), jobParameters);
