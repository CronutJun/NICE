 ...
 *
 * 기관전송 프로그램
 * DreamAutoSendJob (AS-IS DreamAutoSend.pc)
...
public class DreamAutoSendJob implements Job, JobExecuter
{
    ...
    {
        NOrgSendService nOrgSendService = applicationContext.getBean("NDreamAutoSendImpl", NOrgSendService.class);
