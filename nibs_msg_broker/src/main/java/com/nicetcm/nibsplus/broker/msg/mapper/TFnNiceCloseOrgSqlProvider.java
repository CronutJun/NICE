...
import com.nicetcm.nibsplus.broker.msg.model.TFnNiceCloseOrgSpec.Criteria;
import com.nicetcm.nibsplus.broker.msg.model.TFnNiceCloseOrgSpec.Criterion;
import com.nicetcm.nibsplus.broker.msg.model.TFnNiceCloseOrgSpec;
import java.util.List;
import java.util.Map;

public class TFnNiceCloseOrgSqlProvider {
     ...
     */
    public String countBySpec(TFnNiceCloseOrgSpec Spec) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Tue Nov 25 17:19:25 KST 2014
     */
    public String deleteBySpec(TFnNiceCloseOrgSpec Spec) {
        BEGIN();
        DELETE_FROM("OP.T_FN_NICE_CLOSE_ORG");
        applyWhere(Spec, false);
        return SQL();
    }
     ...
     * @mbggenerated Tue Nov 25 17:19:25 KST 2014
     */
    public String insertSelective(TFnNiceCloseOrg record) {
        BEGIN();
        INSERT_INTO("OP.T_FN_NICE_CLOSE_ORG");
     ...
     * @mbggenerated Tue Nov 25 17:19:25 KST 2014
     */
    public String selectBySpec(TFnNiceCloseOrgSpec Spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TFnNiceCloseOrg record = (TFnNiceCloseOrg) parameter.get("record");
        TFnNiceCloseOrgSpec Spec = (TFnNiceCloseOrgSpec) parameter.get("Spec");
     ...
     * @mbggenerated Tue Nov 25 17:19:25 KST 2014
     */
    public String updateByPrimaryKeySelective(TFnNiceCloseOrg record) {
        BEGIN();
        UPDATE("OP.T_FN_NICE_CLOSE_ORG");
     ...
     * @mbggenerated Tue Nov 25 17:19:25 KST 2014
     */
    protected void applyWhere(TFnNiceCloseOrgSpec Spec, boolean includeSpecPhrase) {
        if (Spec == null) {
            return;
        }
