...
import com.nicetcm.nibsplus.broker.msg.model.TFnAtmsCloseSendSpec.Criteria;
import com.nicetcm.nibsplus.broker.msg.model.TFnAtmsCloseSendSpec.Criterion;
import com.nicetcm.nibsplus.broker.msg.model.TFnAtmsCloseSendSpec;
import java.util.List;
import java.util.Map;

public class TFnAtmsCloseSendSqlProvider {
     ...
     */
    public String countBySpec(TFnAtmsCloseSendSpec spec) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Tue Jul 22 10:58:58 KST 2014
     */
    public String deleteBySpec(TFnAtmsCloseSendSpec spec) {
        BEGIN();
        DELETE_FROM("OP.T_FN_ATMS_CLOSE_SEND");
        applyWhere(spec, false);
        return SQL();
    }
     ...
     * @mbggenerated Tue Jul 22 10:58:58 KST 2014
     */
    public String insertSelective(TFnAtmsCloseSend record) {
        BEGIN();
        INSERT_INTO("OP.T_FN_ATMS_CLOSE_SEND");
        ...
        if (record.getCollectAmt() != null) {
            VALUES("COLLECT_AMT", "#{collectAmt,jdbcType=DECIMAL}");
        }
     ...
     * @mbggenerated Tue Jul 22 10:58:58 KST 2014
     */
    public String selectBySpec(TFnAtmsCloseSendSpec spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TFnAtmsCloseSend record = (TFnAtmsCloseSend) parameter.get("record");
        TFnAtmsCloseSendSpec spec = (TFnAtmsCloseSendSpec) parameter.get("spec");
        ...
        if (record.getCollectAmt() != null) {
            SET("COLLECT_AMT = #{record.collectAmt,jdbcType=DECIMAL}");
        }
     ...
     * @mbggenerated Tue Jul 22 10:58:58 KST 2014
     */
    public String updateByPrimaryKeySelective(TFnAtmsCloseSend record) {
        BEGIN();
        UPDATE("OP.T_FN_ATMS_CLOSE_SEND");
        ...
        if (record.getCollectAmt() != null) {
            SET("COLLECT_AMT = #{collectAmt,jdbcType=DECIMAL}");
        }
     ...
     * @mbggenerated Tue Jul 22 10:58:58 KST 2014
     */
    protected void applyWhere(TFnAtmsCloseSendSpec spec, boolean includeSpecPhrase) {
        if (spec == null) {
            return;
        }
