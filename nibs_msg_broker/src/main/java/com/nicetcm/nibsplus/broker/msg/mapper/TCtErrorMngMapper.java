...
public interface TCtErrorMngMapper {
    ...
    int deleteByPrimaryKey(TCtErrorMngKey key);
    ...
    @Select({
        ...
        "UPDATE_UID, ORG_CALL_CNT, CRT_NO",
    ...
    TCtErrorMng selectByPrimaryKey(TCtErrorMngKey key);
     ...
     * @mbggenerated Tue Jul 15 17:08:21 KST 2014
     */
    @UpdateProvider(type=TCtErrorMngSqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(TCtErrorMng record);
    ...
    int updateByPrimaryKey(TCtErrorMng record);
    ...
    int updateByCond1(TCtErrorMng record);
    ...
    TCtErrorMng selectByCond1(TCtErrorMng cond);
    ...
    TCtError getErrGroupCd(TCtErrorMng cond);
    ...
    TCtErrorMng selectByCond2( TCtErrorMng cond );
