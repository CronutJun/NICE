...
public interface TCtErrorMngMapper {
    ...
    @Insert({
        ...
        "#{recvPdaTime,jdbcType=VARCHAR}, #{recvXpos,jdbcType=DECIMAL}, ",
        "#{recvYpos,jdbcType=DECIMAL}, #{recvSido,jdbcType=VARCHAR}, ",
        ...
        "#{finishXpos,jdbcType=DECIMAL}, #{finishYpos,jdbcType=DECIMAL}, ",
        ...
        "#{arrivalXpos,jdbcType=DECIMAL}, #{arrivalYpos,jdbcType=DECIMAL}, ",
    ...
    @Results({
        ...
        @Result(column="RECV_XPOS", property="recvXpos", jdbcType=JdbcType.DECIMAL),
        @Result(column="RECV_YPOS", property="recvYpos", jdbcType=JdbcType.DECIMAL),
        ...
        @Result(column="ARRIVAL_XPOS", property="arrivalXpos", jdbcType=JdbcType.DECIMAL),
        @Result(column="ARRIVAL_YPOS", property="arrivalYpos", jdbcType=JdbcType.DECIMAL),
