...
public class InN3000100Impl extends InMsgHandlerImpl {
    ...
    private void insertNiceCloseTmp( MsgBrokerData safeData, MsgParser parsed ) throws Exception {
        ...
        fnNCT.setEmitCntCw14         ( parsed.getInt   ("emit_cnt_10000"        ) );
        fnNCT.setEmitCntCw54         ( parsed.getInt   ("emit_cnt_50000"        ) );
        fnNCT.setEmitCntCw15         ( parsed.getInt   ("emit_cnt_10000"        ) );
        ...
        fnNCT.setInCntCw14           ( parsed.getInt   ("in_cnt_10000"          ) );
        fnNCT.setInCntCw54           ( parsed.getInt   ("in_cnt_50000"          ) );
        fnNCT.setInCntCw15           ( parsed.getInt   ("in_cnt_100000"         ) );
    ...
    private void insertNiceCloseSum( MsgBrokerData safeData, MsgParser parsed ) throws Exception {
        ...
        cond.setEmitCntCw14         ( parsed.getInt   ("emit_cnt_10000"        ) );
        cond.setEmitCntCw54         ( parsed.getInt   ("emit_cnt_50000"        ) );
        cond.setEmitCntCw15         ( parsed.getInt   ("emit_cnt_10000"        ) );
        ...
        cond.setInCntCw14           ( parsed.getInt   ("in_cnt_10000"          ) );
        cond.setInCntCw54           ( parsed.getInt   ("in_cnt_50000"          ) );
        cond.setInCntCw15           ( parsed.getInt   ("in_cnt_100000"         ) );
