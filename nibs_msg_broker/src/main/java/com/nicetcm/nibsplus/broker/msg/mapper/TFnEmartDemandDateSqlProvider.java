...
import com.nicetcm.nibsplus.broker.msg.model.TFnEmartDemandDateSpec.Criteria;
import com.nicetcm.nibsplus.broker.msg.model.TFnEmartDemandDateSpec.Criterion;
import com.nicetcm.nibsplus.broker.msg.model.TFnEmartDemandDateSpec;
import java.util.List;
import java.util.Map;

public class TFnEmartDemandDateSqlProvider {
     ...
     */
    public String countBySpec(TFnEmartDemandDateSpec spec) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Tue Jul 22 11:13:55 KST 2014
     */
    public String deleteBySpec(TFnEmartDemandDateSpec spec) {
        BEGIN();
        DELETE_FROM("OP.T_FN_EMART_DEMAND_DATE");
        applyWhere(spec, false);
        return SQL();
    }
     ...
     * @mbggenerated Tue Jul 22 11:13:55 KST 2014
     */
    public String insertSelective(TFnEmartDemandDate record) {
        BEGIN();
        INSERT_INTO("OP.T_FN_EMART_DEMAND_DATE");
     ...
     * @mbggenerated Tue Jul 22 11:13:55 KST 2014
     */
    public String selectBySpec(TFnEmartDemandDateSpec spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TFnEmartDemandDate record = (TFnEmartDemandDate) parameter.get("record");
        TFnEmartDemandDateSpec spec = (TFnEmartDemandDateSpec) parameter.get("spec");
     ...
     * @mbggenerated Tue Jul 22 11:13:55 KST 2014
     */
    public String updateByPrimaryKeySelective(TFnEmartDemandDate record) {
        BEGIN();
        UPDATE("OP.T_FN_EMART_DEMAND_DATE");
     ...
     * @mbggenerated Tue Jul 22 11:13:55 KST 2014
     */
    protected void applyWhere(TFnEmartDemandDateSpec spec, boolean includeSpecPhrase) {
        if (spec == null) {
            return;
        }
