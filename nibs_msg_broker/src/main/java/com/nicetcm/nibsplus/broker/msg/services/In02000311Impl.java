...
public class In02000311Impl extends InMsgHandlerImpl {
    ...
    public void inMsgBizProc(MsgBrokerData safeData, MsgParser parsed) throws Exception {
        ...
        cmCSState.setOrgCd 		  ( parsed.getString("SM.org_cd"		) );
        ...
        cmCSState.setInsertUid  	( parsed.getString("MngIn"           	  ) );
        ...
        try {
            ...
            try {
            	...
            	cmSCSSpec.createCriteria().andOrgCdEqualTo(parsed.getString("SM.org_cd"		))
