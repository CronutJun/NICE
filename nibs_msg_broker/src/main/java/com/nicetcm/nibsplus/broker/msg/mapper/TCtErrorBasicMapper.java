...
public interface TCtErrorBasicMapper {
    ...
    @Select({
        ...
        "       T_CT_ERROR ERR",
        "WHERE  MNG.CREATE_DATE = #{createDate, jdbcType=VARCHAR}",
    ...
    @Select({
        ...
        "WHERE   MNG.CREATE_DATE = TO_CHAR(SYSDATE, 'YYYYMMDD')           /* 금일 장애 */    ",
        "AND     MNG.ORG_CD      = #{orgCd, jdbcType=VARCHAR}                                ",
    ...
    @Select({
        ...
        "        ON   BASIC.ERROR_NO = TXN.ERROR_NO                             ",
        "        AND  BASIC.CREATE_DATE = TXN.CREATE_DATE                       ",
        "WHERE   BASIC.CREATE_DATE >= TO_CHAR(sysdate-1,'yyyymmdd')             ",
