 ...
 *
 * MSG Broker NICE 기기정보 Service
 *
 * <pre>
 * MngNI_AP_SaveNiceMacService
 * </pre>
 *
 *           2014. 08. 01    K.D.J.
 */
...
@Service("inN4101600")
public class InN4101600Impl extends InMsgHandlerImpl {

    private static final Logger logger = LoggerFactory.getLogger(InN4101600Impl.class);
