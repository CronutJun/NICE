 ...
 * 조치결과통보
 * <pre>
 * MngEM_AP_SaveMngResult( pRecvData, nLen );
 * </pre>
 *
 ...
 */
@Service("in01101170")
public class In01101170Impl extends InMsgHandlerImpl {
    ...
    public void inMsgBizProc(MsgBrokerData safeData, MsgParser parsed) throws Exception {
        ...
        if(MsgBrokerConst.SHATMS_CODE.equals(parsed.getString("CM.org_cd"))) {
            ...
            **********************************************************************************************/
            ...
            if(parsed.getString("mng_cnt").equals("2")) {
                TCtErrorMngMadeCom tCtErrorMngMadeCom = new TCtErrorMngMadeCom();
                tCtErrorMngMadeCom.setOrgSendYn("4");
            ...
            if(MsgBrokerConst.KBST_CODE.equals(parsed.getString("CM.org_cd"))) {
                ...
                ************************************************************************************************/
                ...
                if(parsed.getString("CM.ret_cd_src").equals("B")) {
                    ...
                    logger.warn("[MngEM_AP_SaveMngResult] 응답코드[{}]수신", parsed.getString("CM.ret_cd_src") + parsed.getString("CM.ret_cd"));
                    return;
                }
                ...
                /*****************************************************************************************
                 응답코드 비정상으로 오면 재송신 하지 않고 차후 모니터링 하도록 처리
                *****************************************************************************************/
                ...
                logger.warn("[MngEM_AP_SaveMngResult] 조치결과가 지원되지 않는 기관입니다.[%s]", parsed.getString("CM.org_cd"));
                throw new Exception("[MngEM_AP_SaveMngResult] 조치결과가 지원되지 않는 기관입니다.[" + parsed.getString("CM.org_cd") + "]");
            }
        ...
        logger.warn( "[MngEM_AP_SaveMngResult] Update OK" );
