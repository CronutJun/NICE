...
import com.nicetcm.nibsplus.broker.msg.model.TFnTicketMacCloseTmpSpec.Criteria;
import com.nicetcm.nibsplus.broker.msg.model.TFnTicketMacCloseTmpSpec.Criterion;
import com.nicetcm.nibsplus.broker.msg.model.TFnTicketMacCloseTmpSpec;
import java.util.List;
import java.util.Map;

public class TFnTicketMacCloseTmpSqlProvider {
     ...
     */
    public String countBySpec(TFnTicketMacCloseTmpSpec spec) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    public String deleteBySpec(TFnTicketMacCloseTmpSpec spec) {
        BEGIN();
        DELETE_FROM("OP.T_FN_TICKET_MAC_CLOSE_TMP");
        applyWhere(spec, false);
        return SQL();
    }
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    public String insertSelective(TFnTicketMacCloseTmp record) {
        BEGIN();
        INSERT_INTO("OP.T_FN_TICKET_MAC_CLOSE_TMP");
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    public String selectBySpec(TFnTicketMacCloseTmpSpec spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TFnTicketMacCloseTmp record = (TFnTicketMacCloseTmp) parameter.get("record");
        TFnTicketMacCloseTmpSpec spec = (TFnTicketMacCloseTmpSpec) parameter.get("spec");
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    public String updateByPrimaryKeySelective(TFnTicketMacCloseTmp record) {
        BEGIN();
        UPDATE("OP.T_FN_TICKET_MAC_CLOSE_TMP");
     ...
     * @mbggenerated Wed Jul 30 15:45:45 KST 2014
     */
    protected void applyWhere(TFnTicketMacCloseTmpSpec spec, boolean includeSpecPhrase) {
        if (spec == null) {
            return;
        }
