...
import com.nicetcm.nibsplus.broker.msg.model.TFnInoutRealtimeSpec.Criteria;
import com.nicetcm.nibsplus.broker.msg.model.TFnInoutRealtimeSpec.Criterion;
import com.nicetcm.nibsplus.broker.msg.model.TFnInoutRealtimeSpec;
import java.util.List;
import java.util.Map;

public class TFnInoutRealtimeSqlProvider {
     ...
     */
    public String countBySpec(TFnInoutRealtimeSpec spec) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Tue Jul 22 10:58:58 KST 2014
     */
    public String deleteBySpec(TFnInoutRealtimeSpec spec) {
        BEGIN();
        DELETE_FROM("OP.T_FN_INOUT_REALTIME");
        applyWhere(spec, false);
        return SQL();
    }
     ...
     * @mbggenerated Tue Jul 22 10:58:58 KST 2014
     */
    public String insertSelective(TFnInoutRealtime record) {
        BEGIN();
        INSERT_INTO("OP.T_FN_INOUT_REALTIME");
     ...
     * @mbggenerated Tue Jul 22 10:58:58 KST 2014
     */
    public String selectBySpec(TFnInoutRealtimeSpec spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TFnInoutRealtime record = (TFnInoutRealtime) parameter.get("record");
        TFnInoutRealtimeSpec spec = (TFnInoutRealtimeSpec) parameter.get("spec");
     ...
     * @mbggenerated Tue Jul 22 10:58:58 KST 2014
     */
    public String updateByPrimaryKeySelective(TFnInoutRealtime record) {
        BEGIN();
        UPDATE("OP.T_FN_INOUT_REALTIME");
     ...
     * @mbggenerated Tue Jul 22 10:58:58 KST 2014
     */
    protected void applyWhere(TFnInoutRealtimeSpec spec, boolean includeSpecPhrase) {
        if (spec == null) {
            return;
        }
