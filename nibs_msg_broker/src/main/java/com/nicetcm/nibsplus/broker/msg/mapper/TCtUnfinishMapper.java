...
public interface TCtUnfinishMapper {
    ...
    @Select({
        ...
        "        DECODE(NVL(SUM(DECODE(ERROR_CD, 'NI102', 1, 0)), 0), 0, '0', '1')||               ",
        "        DECODE(NVL(SUM(DECODE(ERROR_CD, 'NI151', 1, 0)), 0), 0, '0', '1')||               ",
        "        DECODE(NVL(SUM(DECODE(ERROR_CD, 'NI145', 1, 0)), 0), 0, '0', '1') AS ERROR_STATES ",
        "FROM    OP.T_CT_UNFINISH                                                                  ",
