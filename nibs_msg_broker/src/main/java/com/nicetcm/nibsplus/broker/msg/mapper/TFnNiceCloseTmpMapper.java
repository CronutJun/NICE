...
public interface TFnNiceCloseTmpMapper {
    ...
    @Select({
        ...
        "       NVL( SUM( EMIT_CNT_10000 ),        0 ) + #{emitCnt10000,         jdbcType=DECIMAL} AS EMIT_CNT_10000        , ",
        "       NVL( SUM( EMIT_CNT_50000 ),        0 ) + #{emitCnt50000,         jdbcType=DECIMAL} AS EMIT_CNT_50000        , ",
        "       NVL( SUM( EMIT_CNT_100000 ),       0 ) + #{emitCnt100000,        jdbcType=DECIMAL} AS EMIT_CNT_100000       , ",
        ...
        "       NVL( SUM( IN_CNT_10000 ),          0 ) + #{inCnt10000,           jdbcType=DECIMAL} AS IN_CNT_10000          , ",
        "       NVL( SUM( IN_CNT_50000 ),          0 ) + #{inCnt50000,           jdbcType=DECIMAL} AS IN_CNT_50000          , ",
        "       NVL( SUM( IN_CNT_100000 ),         0 ) + #{inCnt100000,          jdbcType=DECIMAL} AS IN_CNT_100000         , ",
