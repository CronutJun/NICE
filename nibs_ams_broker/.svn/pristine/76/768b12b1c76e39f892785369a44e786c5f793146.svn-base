...
@Service("out21005003")
public class Out21005003Impl implements OutMsgHandler {

    private static final Logger logger = LoggerFactory.getLogger(Out21005003Impl.class);
    ...
    public void outMsgHandle(MsgParser outMsg, AMSBrokerData safeData, AMSBrokerReqJob reqJob, AMSBrokerReqInfo reqInfo, TRmMsg msg) throws Exception {
        ...
        outMsg.setString( "CM._AOCMsgCode",           msg.getMsgCd())
              ...
              .setString( "_AOCUpFileType",           reqJob.getFileType() )
              .setString( "_AOCUpFileDate",           reqJob.getFileDate() )
              .setString( "_AOCUpFileCompress",       "1" )
              .syncMessage();
