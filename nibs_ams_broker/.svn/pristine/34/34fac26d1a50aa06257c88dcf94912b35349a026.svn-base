...
import com.nicetcm.nibsplus.broker.ams.model.TRcIniInfSpec.Criteria;
import com.nicetcm.nibsplus.broker.ams.model.TRcIniInfSpec.Criterion;
import com.nicetcm.nibsplus.broker.ams.model.TRcIniInfSpec;
import java.util.List;
import java.util.Map;

public class TRcIniInfSqlProvider {
     ...
     */
    public String countBySpec(TRcIniInfSpec spec) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Tue Aug 19 16:35:31 KST 2014
     */
    public String deleteBySpec(TRcIniInfSpec spec) {
        BEGIN();
        DELETE_FROM("IN.T_RC_INI_INF");
        applyWhere(spec, false);
        return SQL();
    }
     ...
     * @mbggenerated Tue Aug 19 16:35:31 KST 2014
     */
    public String insertSelective(TRcIniInf record) {
        BEGIN();
        INSERT_INTO("IN.T_RC_INI_INF");
     ...
     * @mbggenerated Tue Aug 19 16:35:31 KST 2014
     */
    public String selectBySpec(TRcIniInfSpec spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TRcIniInf record = (TRcIniInf) parameter.get("record");
        TRcIniInfSpec spec = (TRcIniInfSpec) parameter.get("spec");
     ...
     * @mbggenerated Tue Aug 19 16:35:31 KST 2014
     */
    public String updateByPrimaryKeySelective(TRcIniInf record) {
        BEGIN();
        UPDATE("IN.T_RC_INI_INF");
     ...
     * @mbggenerated Tue Aug 19 16:35:31 KST 2014
     */
    protected void applyWhere(TRcIniInfSpec spec, boolean includeSpecPhrase) {
        if (spec == null) {
            return;
        }
