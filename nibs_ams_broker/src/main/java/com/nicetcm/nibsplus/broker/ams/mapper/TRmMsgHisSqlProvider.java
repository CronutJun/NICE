...
import com.nicetcm.nibsplus.broker.ams.model.TRmMsgHisSpec.Criteria;
import com.nicetcm.nibsplus.broker.ams.model.TRmMsgHisSpec.Criterion;
import com.nicetcm.nibsplus.broker.ams.model.TRmMsgHisSpec;
import java.util.List;
import java.util.Map;

public class TRmMsgHisSqlProvider {
     ...
     */
    public String countBySpec(TRmMsgHisSpec spec) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated  Mon Aug 18 10:55:09 KST 2014
     */
    public String deleteBySpec(TRmMsgHisSpec spec) {
        BEGIN();
        DELETE_FROM("IN.T_RM_MSG_HIS");
        applyWhere(spec, false);
        return SQL();
    }
     ...
     * @mbggenerated  Mon Aug 18 10:55:09 KST 2014
     */
    public String insertSelective(TRmMsgHis record) {
        BEGIN();
        INSERT_INTO("IN.T_RM_MSG_HIS");
        ...
        if (record.getMsgCtx() != null) {
            VALUES("MSG_CTX", "#{msgCtx,jdbcType=VARCHAR}");
        }
        return SQL();
    }
     ...
     * @mbggenerated  Mon Aug 18 10:55:09 KST 2014
     */
    public String selectBySpec(TRmMsgHisSpec spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TRmMsgHis record = (TRmMsgHis) parameter.get("record");
        TRmMsgHisSpec spec = (TRmMsgHisSpec) parameter.get("spec");
        BEGIN();
        UPDATE("IN.T_RM_MSG_HIS");
        if (record.getCreateDate() != null) {
        ...
        if (record.getMsgCtx() != null) {
            SET("MSG_CTX = #{record.msgCtx,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated  Mon Aug 18 10:55:09 KST 2014
     */
    public String updateByPrimaryKeySelective(TRmMsgHis record) {
        BEGIN();
        UPDATE("IN.T_RM_MSG_HIS");
        if (record.getCreateTime() != null) {
        ...
        if (record.getMsgCtx() != null) {
            SET("MSG_CTX = #{msgCtx,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated  Mon Aug 18 10:55:09 KST 2014
     */
    protected void applyWhere(TRmMsgHisSpec spec,
