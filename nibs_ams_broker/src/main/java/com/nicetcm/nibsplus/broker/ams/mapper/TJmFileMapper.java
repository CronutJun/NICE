...
public interface TJmFileMapper {
    ...
    @Insert({
        ...
        "#{fileName,jdbcType=VARCHAR}, #{zipFileName,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "MAC_TRX_DATE, ORG_CD, BRANCH_CD, MAC_NO, FILE_NAME, ZIP_FILE_NAME, INSERT_DATE, ",
