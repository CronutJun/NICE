...
import com.nicetcm.nibsplus.broker.ams.model.TRcRegInfSpec.Criteria;
import com.nicetcm.nibsplus.broker.ams.model.TRcRegInfSpec.Criterion;
import com.nicetcm.nibsplus.broker.ams.model.TRcRegInfSpec;
import java.util.List;
import java.util.Map;

public class TRcRegInfSqlProvider {
     ...
     */
    public String countBySpec(TRcRegInfSpec spec) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Tue Aug 19 16:35:31 KST 2014
     */
    public String deleteBySpec(TRcRegInfSpec spec) {
        BEGIN();
        DELETE_FROM("IN.T_RC_REG_INF");
        applyWhere(spec, false);
        return SQL();
    }
     ...
     * @mbggenerated Tue Aug 19 16:35:31 KST 2014
     */
    public String insertSelective(TRcRegInf record) {
        BEGIN();
        INSERT_INTO("IN.T_RC_REG_INF");
     ...
     * @mbggenerated Tue Aug 19 16:35:31 KST 2014
     */
    public String selectBySpec(TRcRegInfSpec spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TRcRegInf record = (TRcRegInf) parameter.get("record");
        TRcRegInfSpec spec = (TRcRegInfSpec) parameter.get("spec");
     ...
     * @mbggenerated Tue Aug 19 16:35:31 KST 2014
     */
    public String updateByPrimaryKeySelective(TRcRegInf record) {
        BEGIN();
        UPDATE("IN.T_RC_REG_INF");
     ...
     * @mbggenerated Tue Aug 19 16:35:31 KST 2014
     */
    protected void applyWhere(TRcRegInfSpec spec, boolean includeSpecPhrase) {
        if (spec == null) {
            return;
        }
