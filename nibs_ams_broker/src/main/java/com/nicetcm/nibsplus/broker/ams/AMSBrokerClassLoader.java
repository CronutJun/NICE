...
public class AMSBrokerClassLoader extends ClassLoader {

    private static final Logger logger = LoggerFactory.getLogger(AMSBrokerClassLoader.class);

    private URL url;
    private String classNm = null;

    public AMSBrokerClassLoader() throws Exception {

        super(AMSBrokerClassLoader.class.getClassLoader());
