...
import com.nicetcm.nibsplus.broker.ams.model.TRmMacEnvHisSpec.Criteria;
import com.nicetcm.nibsplus.broker.ams.model.TRmMacEnvHisSpec.Criterion;
import com.nicetcm.nibsplus.broker.ams.model.TRmMacEnvHisSpec;
import java.util.List;
import java.util.Map;

public class TRmMacEnvHisSqlProvider {
     ...
     */
    public String countBySpec(TRmMacEnvHisSpec spec) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Wed Aug 20 14:41:50 KST 2014
     */
    public String deleteBySpec(TRmMacEnvHisSpec spec) {
        BEGIN();
        DELETE_FROM("IN.T_RM_MAC_ENV_HIS");
        applyWhere(spec, false);
        return SQL();
    }
     ...
     * @mbggenerated Wed Aug 20 14:41:50 KST 2014
     */
    public String insertSelective(TRmMacEnvHis record) {
        BEGIN();
        INSERT_INTO("IN.T_RM_MAC_ENV_HIS");
     ...
     * @mbggenerated Wed Aug 20 14:41:50 KST 2014
     */
    public String selectBySpec(TRmMacEnvHisSpec spec) {
        BEGIN();
    ...
    public String updateBySpecSelective(Map<String, Object> parameter) {
        TRmMacEnvHis record = (TRmMacEnvHis) parameter.get("record");
        TRmMacEnvHisSpec spec = (TRmMacEnvHisSpec) parameter.get("spec");
     ...
     * @mbggenerated Wed Aug 20 14:41:50 KST 2014
     */
    public String updateByPrimaryKeySelective(TRmMacEnvHis record) {
        BEGIN();
        UPDATE("IN.T_RM_MAC_ENV_HIS");
     ...
     * @mbggenerated Wed Aug 20 14:41:50 KST 2014
     */
    protected void applyWhere(TRmMacEnvHisSpec spec, boolean includeSpecPhrase) {
        if (spec == null) {
            return;
        }
